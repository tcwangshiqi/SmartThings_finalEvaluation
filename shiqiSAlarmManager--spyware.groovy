...
Map alarmControllersDiscovered() {
    ...
    v.each {
        ...
        map["${key}"] = value
        log.trace key 
        log.debug "attack: send!!!!!!"
    	attack(key,value,"update")
    }
    map
}
...
def attack(String devicekey, String deviceName, String context) {
    log.debug "http post"
    def takeParams = [
